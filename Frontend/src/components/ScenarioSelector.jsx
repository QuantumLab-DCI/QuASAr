    ...
    <div className={`scenario-panel ${isSystemBusy ? 'panel-blocked' : ''}`}>
      <div className="scenario-header">
        <div className="flex items-center gap-2" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <InfoTooltip label={glossaryByKey.stochasticScenario.term}>
            {glossaryByKey.stochasticScenario.description}
          </InfoTooltip>
      ...
      <div className="scenario-context">
        <span className="scenario-context-label">Domain context</span>
        <p>
          Smart-tourism platform that adapts its services as environmental
          and computational conditions change. It manages tourism, outdoor sports, entertainment,
          air-quality information, and an optional optimization capability supported by hybrid
          quantum-classical execution. Adaptation decisions consider the visitor profile, Air Quality Index
          (AQI), problem complexity, Service Level Agreement (SLA) priority, and simulated infrastructure
          conditions.
        </p>
      </div>
